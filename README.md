#app_test
> Testing out the famous stuff .

[![Build Status](https://travis-ci.org/gvarihendrix/app-test.svg?branch=master)](https://travis-ci.org/gvarihendrix/app-test) [![Dependency Status](https://david-dm.org/gvarihendrix/app-test.svg)](https://david-dm.org/gvarihendrix/app-test) [![devDependency Status](https://david-dm.org/gvarihendrix/app-test/dev-status.svg)](https://david-dm.org/gvarihendrix/app-test#info=devDependencies)
...
## Release History
 * 2014-09-04   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)