define(function(require, exports, module) {
    ...
    var Timer = requier('famous/utilities/Timer');
    ...
    function _createIcons() {
        ...
        var equalsIcon = new Surface({
            size: [40, 40],
            content: '<img height=40px width=40px src="content/img/bottomIcons/equals-icon.png"/>'
        });
        ...
        this.container._add(equalsIconMod).add(equalsIcon);

        var middleIcon = new Surface({
            size: [100, 100],
            content: '<img height=100px width=100px src="content/img/bottomIcons/camera-icon.png"/>'
        });
        ...
        this.container._add(middleIconMod).add(middleIcon);

        var nextIcon = new Surface({
            size: [40, 40],
            content: '<img height=40px width=40px src="content/img/bottomIcons/next-icon.png"/>'
        });
    ...
    BottomIconsView.prototype.animateDown = function() {
        this.modifire.setOrigin([0.5, 2], {duration: 400});
    };
